...
<div class="tb-dashboard-sections">
    <section class="tb-dashboard-section">
        ...
        <a href="/exercises" class="tb-action-card tb-dashboard-link">
            <div>
                <h3>Database</h3>
    ...
    <?php if (isset($_SESSION['current_team'])): ?>
        <section class="tb-dashboard-section tb-card tb-dashboard-team-card">
            ...
            <div class="tb-dashboard-link-list">
                <a href="/players" class="tb-action-card tb-dashboard-link">
                    <div>
                        <h3>Spelers</h3>
                ...
                <a href="/trainings" class="tb-action-card tb-dashboard-link">
                    <div>
                        <h3>Trainingen</h3>
                ...
                <a href="/tactics" class="tb-action-card tb-dashboard-link">
                    <div>
                        <h3>Tactiekstudio</h3>
                ...
                <a href="/matches" class="tb-action-card tb-dashboard-link">
                    <div>
                        <h3>Wedstrijden</h3>
                ...
                <a href="/matches/reports" class="tb-action-card tb-dashboard-link">
                    <div>
                        <h3>Rapportage</h3>
    ...
    <?php else: ?>
        <section class="tb-dashboard-section">
            ...
            <?php if (empty($teams)): ?>
                <div class="tb-card tb-dashboard-empty-card">
                ...
                <div class="tb-dashboard-team-select-grid">
                    <?php foreach ($teams as $team): ?>
                        ...
                        <form method="POST" action="/team/select" class="tb-dashboard-team-select-form">
                            ...
                            <button type="submit" class="tb-action-card tb-dashboard-team-select">
