<div class="app-bar">
    ...
    <div class="app-bar-actions">
        ...
        <a href="/trainings?sort=<?= $nextSort ?>" class="btn-icon-round" title="<?= ($currentSort ?? 'asc') === 'desc' ? 'Sorteer: Oudste eerst' : 'Sorteer: Nieuwste eerst' ?>" aria-label="<?= ($currentSort ?? 'asc') === 'desc' ? 'Sorteer: Oudste eerst' : 'Sorteer: Nieuwste eerst' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<a href="/trainings/create" class="tb-fab" title="Nieuwe Training" aria-label="Nieuwe training">
