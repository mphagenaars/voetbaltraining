<div class="container">
    ...
    $tacticsBoardData = $matchTactics ?? [];
    $tacticsContextMode = 'match';
    $tacticsTeamId = (int)($match['team_id'] ?? 0);
    $tacticsMatchId = (int)($match['id'] ?? 0);
    $tacticsSaveEndpoint = '/matches/tactics/save';
    $tacticsDeleteEndpoint = '/matches/tactics/delete';
    $tacticsExportEndpoint = '/matches/tactics/export-video';
    $tacticsListSort = 'sort_order';
    $tacticsShowSourceMeta = false;
